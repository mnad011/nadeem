...
#P1=jopplusbenchmarks
#P2=demoloopprocessor
#P3=DemoloopJopplus
#P1=test
#P2=test
#P3=HelloWorld
...
TARGET_JFLAGS=-d $(TARGET)/dist/classes -sourcepath $(TARGET_SOURCE) -bootclasspath "" -extdirs "" -classpath ".$(S)*" -source 1.5 -target 1.5 -encoding Latin1
GCC_PARAMS=
...
#	javac $(TOOLS_JFLAGS) $(TOOLS)/src/com/jopdesign/debug/jdwp/*.java
	rm $(TOOLS)/dist/classes/com/jopdesign/wcet/report/*.vm
...
java_app: 
	...
	(cd java/target/dist/classes ; jar -xvf ../../../../System*.jar)
	make jop_config
	#javac $(TARGET_JFLAGS) $(TARGET_SRC_PATH)/jdk14/java/util/*.java
