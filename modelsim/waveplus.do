...
add wave -noupdate -format Literal /tb_jop/joptop/cpu/core/bcf/bc1/val
...
add wave -noupdate -format Logic -radix hexadecimal /tb_jop/joptop/cpu/core/gals/ctrlreg
...
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/ctrl_mem_addr
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/bc1/jinstr
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/jbc_data2
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/ctrlopd
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/gals/ctrljpc
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/gals/regf/*
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/gals/rf_wb_value
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/gals/T
add wave -noupdate -format Logic /tb_jop/joptop/cpu/core/bcf/dm_wr_en
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/data_mem/reg_wr_addr
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/gals/dm_data
add wave -noupdate -format Literal -radix hexadecimal /tb_jop/joptop/cpu/core/bcf/data_mem/reg_rd_addr

add wave -noupdate -format Literal -radix hexadecimal tb_jop/joptop/cpu/core/bcf/data_mem/q
add wave -noupdate -format Literal -radix hexadecimal tb_jop/joptop/cpu/core/bcf/data_mem/ram
