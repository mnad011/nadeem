...
public class Instruction implements Serializable {
	...
	private static Instruction[] ia = new Instruction[] {
			...
			new Instruction("stctrlpc", 0x007, 0, JmpType.NOP, StackType.POP),
			new Instruction("stmainptr", 0x008, 0, JmpType.NOP, StackType.POP),
			// st (vp) 3 bits
			...
			new Instruction("rdrf", 0x104, 0, JmpType.NOP, StackType.NOP),
			new Instruction("wrrf", 0x105, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldctrlpct", 0x106, 0, JmpType.NOP, StackType.NOP),
			new Instruction("toggle", 0x107, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldmaint", 0x108, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldctrlopdt", 0x109, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldmainptrt", 0x10a, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldrzt", 0x10b, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldrxt", 0x10c, 0, JmpType.NOP, StackType.NOP),
			new Instruction("wrdm", 0x10d, 0, JmpType.NOP, StackType.NOP),
			new Instruction("lddmt", 0x10e, 0, JmpType.NOP, StackType.NOP),
			new Instruction("wrimm", 0x10f, 0, JmpType.NOP, StackType.NOP),
			...
			new Instruction("ldmaxt", 0x120, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldonet", 0x121, 0, JmpType.NOP, StackType.NOP),
			new Instruction("seot", 0x122, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ceot", 0x123, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldert", 0x124, 0, JmpType.NOP, StackType.NOP),
			new Instruction("cer", 0x125, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ssvop", 0x126, 0, JmpType.NOP, StackType.NOP),
			new Instruction("sop", 0x127, 0, JmpType.NOP, StackType.NOP),
			new Instruction("ldsipt", 0x128, 0, JmpType.NOP, StackType.NOP),
			new Instruction("stzf", 0x129, 0, JmpType.NOP, StackType.NOP),
			new Instruction("clzf", 0x12A, 0, JmpType.NOP, StackType.NOP),
