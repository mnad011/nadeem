...
case29807 NOOP; Switch Child branch
  ...
  JMP OVERELSE29965
else29964 NOOP
  LDR R0 #73 ; loading case number
  DCALLBL R0 ; casenumber 73
  LDR R0 $2 ; loading from mem
  OR R0 R0 #32768 ;loading the emit signal in
  STR R0 $2; emitted signal PWAVE_1 in mem
    LDR R0 #74 ; loading case number
...
case29822 NOOP; Switch Child branch
  ...
  JMP OVERELSE30003
else30002 NOOP
  LDR R0 #101 ; loading case number
...
case29823 NOOP; Switch Child branch
  ...
  LDR R0 #102 ; loading case number
  DCALLBL R0 ; casenumber 102
  LDR R0 #case29819
  STR R0 $17; EnterNode storing statecode : 0
  LDR R0 #103 ; loading case number
...
case29832 NOOP; Switch Child branch
  ...
  LDR R0 #case29833
  STR R0 $1c; EnterNode storing statecode : 1
  LDR R0 #108 ; loading case number
  ...
  OR R0 R0 #512 ;loading the emit signal in
  STR R0 $2; emitted signal lastAtriumActivity_1 in mem
    LDR R0 #109 ; loading case number
  ...
  JMP OVERELSE30017
else30016 NOOP
  LDR R0 #110 ; loading case number
...
else30020 NOOP
  ...
  JMP OVERELSE30026
else30025 NOOP
  LDR R0 #106 ; loading case number
...
FALSE30031
  ...
  JMP OVERELSE30032
else30028 NOOP
  LDR R0 #107 ; loading case number
...
case29833 NOOP; Switch Child branch
  ...
  JMP OVERELSE30035
else30034 NOOP
  LDR R0 #113 ; loading case number
...
case29831 NOOP; Switch Child branch
  ...
  LDR R0 #114 ; loading case number
...
case29829 NOOP; Switch Child branch
  ...
  LDR R0 #case29828
  STR R0 $1a; EnterNode storing statecode : 0
  LDR R0 #115 ; loading case number
  ...
  LDR R0 #case29833
  STR R0 $1c; EnterNode storing statecode : 1
  LDR R0 #117 ; loading case number
  ...
  OR R0 R0 #512 ;loading the emit signal in
  STR R0 $2; emitted signal lastAtriumActivity_1 in mem
    LDR R0 #118 ; loading case number
  ...
  JMP OVERELSE30042
else30041 NOOP
  LDR R0 #119 ; loading case number
...
FALSE30047
  ...
  JMP OVERELSE30048
else30044 NOOP
  LDR R0 #116 ; loading case number
...
case29842 NOOP; Switch Child branch
  ...
  NOOP;
else30060 NOOP
  LDR R0 #122 ; loading case number
...
case29841 NOOP; Switch Child branch
  ...
  LDR R0 #case29842
  STR R0 $21; EnterNode storing statecode : 0
  LDR R0 #123 ; loading case number
...
case29848 NOOP; Switch Child branch
  ...
  JMP OVERELSE30071
else30070 NOOP
  LDR R0 #126 ; loading case number
...
case29847 NOOP; Switch Child branch
  ...
  LDR R0 #case29848
  STR R0 $24; EnterNode storing statecode : 0
  LDR R0 #127 ; loading case number
...
case29854 NOOP; Switch Child branch
  ...
  JMP OVERELSE30081
else30080 NOOP
  LDR R0 #130 ; loading case number
...
case29853 NOOP; Switch Child branch
  ...
  LDR R0 #case29854
  STR R0 $27; EnterNode storing statecode : 0
  LDR R0 #131 ; loading case number
...
case29864 NOOP; Switch Child branch
  ...
  LDR R0 #case29865
  STR R0 $2c; EnterNode storing statecode : 1
  LDR R0 #138 ; loading case number
  ...
  OR R0 R0 #1024 ;loading the emit signal in
  STR R0 $2; emitted signal lastVentricularActivity_1 in mem
    LDR R0 #139 ; loading case number
  ...
  JMP OVERELSE30096
else30095 NOOP
  LDR R0 #140 ; loading case number
...
else30100 NOOP
  ...
  OR R0 R0 #256 ;loading the emit signal in
  STR R0 $2; emitted signal atriumActivityOccured_1 in mem
  LDR R0 #135 ; loading case number
  ...
  STR R1 $8
    JMP OVERELSE30106
else30105 NOOP
  LDR R0 #136 ; loading case number
...
FALSE30111
  ...
  JMP OVERELSE30112
else30108 NOOP
  LDR R0 #137 ; loading case number
...
case29870 NOOP; Switch Child branch
  ...
  JMP OVERELSE30117
else30116 NOOP
  LDR R0 #143 ; loading case number
...
case29863 NOOP; Switch Child branch
  ...
  LDR R0 #case29862
  STR R0 $2b; EnterNode storing statecode : 0
  LDR R0 #144 ; loading case number
  ...
  LDR R0 #case29865
  STR R0 $2c; EnterNode storing statecode : 1
  LDR R0 #146 ; loading case number
  ...
  OR R0 R0 #1024 ;loading the emit signal in
  STR R0 $2; emitted signal lastVentricularActivity_1 in mem
    LDR R0 #147 ; loading case number
  ...
  JMP OVERELSE30123
else30122 NOOP
  LDR R0 #148 ; loading case number
...
FALSE30128
  ...
  JMP OVERELSE30129
else30125 NOOP
  LDR R0 #145 ; loading case number
...
case29878 NOOP; Switch Child branch
  ...
  LDR R0 #152 ; loading case number
...
case29880 NOOP; Switch Child branch
  ...
  JMP OVERELSE30146
else30145 NOOP
  LDR R0 #151 ; loading case number
...
case29877 NOOP; Switch Child branch
  ...
  LDR R0 #case29880
  STR R0 $34; EnterNode storing statecode : 0
  LDR R0 #153 ; loading case number
...
case29883 NOOP; Switch Child branch
  ...
  LDR R0 #case29884
  STR R0 $36; EnterNode storing statecode : 0
  LDR R0 #157 ; loading case number
...
case29884 NOOP; Switch Child branch
  ...
  JMP OVERELSE30158
else30157 NOOP
  LDR R0 #156 ; loading case number
...
OVERELSE30211 NOOP;
  ...
  LDR R0 #case29828
  STR R0 $1a; EnterNode storing statecode : 0
  LDR R0 #168 ; loading case number
  ...
  LDR R0 #case29833
  STR R0 $1c; EnterNode storing statecode : 1
  LDR R0 #170 ; loading case number
  ...
  OR R0 R0 #512 ;loading the emit signal in
  STR R0 $2; emitted signal lastAtriumActivity_1 in mem
    LDR R0 #171 ; loading case number
  ...
  JMP OVERELSE30223
else30222 NOOP
  LDR R0 #172 ; loading case number
...
FALSE30228
  ...
  JMP OVERELSE30229
else30225 NOOP
  LDR R0 #169 ; loading case number
...
OVERELSE30231 NOOP;
  ...
  LDR R0 #case29842
  STR R0 $21; EnterNode storing statecode : 0
  LDR R0 #173 ; loading case number
  ...
  LDR R0 #case29848
  STR R0 $24; EnterNode storing statecode : 0
  LDR R0 #174 ; loading case number
  ...
  LDR R0 #case29854
  STR R0 $27; EnterNode storing statecode : 0
  LDR R0 #175 ; loading case number
...
DUMMY30234
  ...
  LDR R0 #case29862
  STR R0 $2b; EnterNode storing statecode : 0
  LDR R0 #176 ; loading case number
  ...
  LDR R0 #case29865
  STR R0 $2c; EnterNode storing statecode : 1
  LDR R0 #178 ; loading case number
  ...
  OR R0 R0 #1024 ;loading the emit signal in
  STR R0 $2; emitted signal lastVentricularActivity_1 in mem
    LDR R0 #179 ; loading case number
  ...
  JMP OVERELSE30239
else30238 NOOP
  LDR R0 #180 ; loading case number
...
FALSE30244
  ...
  JMP OVERELSE30245
else30241 NOOP
  LDR R0 #177 ; loading case number
...
OVERELSE30246 NOOP;
  ...
  LDR R0 #case29880
  STR R0 $34; EnterNode storing statecode : 0
  LDR R0 #181 ; loading case number
  ...
  LDR R0 #case29884
  STR R0 $36; EnterNode storing statecode : 0
  LDR R0 #182 ; loading case number
